        ...
        if(getMobile.equals("")){otp_mobile.setError("Enter Mobile Number");otp_mobile.requestFocus();}
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    PutData putData = new PutData("https://mediapprove.net/android/otp/register_otp.php", "POST", field, data);
                    ...
                    if (putData.startPut()) {
                        ...
                        if (putData.onComplete()) {
                            ...
                            if(result.equals("otp sent")){
                                ...
                                Intent in = new Intent(getApplicationContext(), OTP_confirm.class);
