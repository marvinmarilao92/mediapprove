...
public class CP_OTP_confirm extends AppCompatActivity {
    String mobile_no="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mobilenum = sharedPreferences.getString("mobile_CP","");
...
//                                editor.putString("mobileno",null);
                                Toast.makeText(getApplicationContext(), "you can now change your password", Toast.LENGTH_SHORT).show();
                                SharedPreferences sharedPreferences = getSharedPreferences("checkbox", Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = sharedPreferences.edit();
                                editor.putString("Con_mobile_CP",getNo);
                                editor.putString("mobile_CP",null);
                                editor.apply();//create your session
                                //making an intent to move to another activity
                                Intent in = new Intent(getApplicationContext(), ChangePass.class);
